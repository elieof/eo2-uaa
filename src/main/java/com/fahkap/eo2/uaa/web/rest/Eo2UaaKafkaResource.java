...
@RestController
@RequestMapping("/api/eo-2-uaa-kafka")
public class Eo2UaaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(Eo2UaaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Eo2UaaKafkaResource(KafkaProperties kafkaProperties) {
